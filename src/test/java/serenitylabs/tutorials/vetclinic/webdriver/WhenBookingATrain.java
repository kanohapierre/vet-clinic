...
public class WhenBookingATrain {
    ...
    static final Map<DeparturePreference, org.openqa.selenium.By> DEPARTURE_RADIO_BUTTONS = new HashMap<>();
    static {
    ...
    private static final DecimalFormat TIME_UNIT_FORMAT = new java.text.DecimalFormat("##");

    private void theTrainShould(DeparturePreference departurePreference, int hour, int minute, TravelDay travelDay) {
